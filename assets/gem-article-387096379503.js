...
jQuery(function() {
  try {
    var $module = jQuery('#m-1588241978802').children('.module');   
    ...
    if ($module.parent().parent().closest('.module-wrap[data-label="Carousel"]').length > 0) {	
        ...
        jQuery(function() {
            var $module = jQuery('#m-1587909986402').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1587909986386').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1587909986466');
            var $module = jQuery('#m-1587909986466').children('.module');
