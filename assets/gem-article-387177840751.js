...
jQuery(function() {
  var $module = jQuery('#m-1588678552559');
  ...
  if(mode == 'dev') {
    var moduleId = "1588678552559";
    var moduleIdSlug = moduleId.toString().replace(/-/g, '');
    if (moduleIdSlug == "1588678552559") {
      window.getParallax1588678552559 = function() {
  ...
  try {
    var $module = jQuery('#m-1588676072442').children('.module');   
    ...
    if ($module.parent().parent().closest('.module-wrap[data-label="Carousel"]').length > 0) {	
        ...
        jQuery(function() {
            var $module = jQuery('#m-1588676072552').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1588676072515').children('.module');
