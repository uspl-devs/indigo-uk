    ...
    jQuery(function() {
        try {
            var $module = jQuery('#m-1567257817364').children('.module');
            var navspeed = $module.data('navspeed'),
                autoplaytimeout = $module.data('autoplaytimeout'),
                autoplayhoverpause = $module.data('autoplayhoverpause'),
                navlg = $module.data('navlg'),
    ...
    jQuery(function() {
        var $hero = jQuery('#m-1567257838972');
        var $module = jQuery('#m-1567257838972').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1542854810989');
            var $module = jQuery('#m-1542854810989').children('.module');
