    ...
    jQuery(function() {
  var $hero = jQuery('#m-1604589069770');
  var $module = jQuery('#m-1604589069770').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    jQuery(function() {
      var $module = jQuery('#m-1575541044740').children('.module');
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1575541173012').children('.module');
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1575541272708').children('.module');
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1579699522320').children('.module');
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1579699522354').children('.module');
    });
  
    jQuery(function() {
      var $module = jQuery('#m-1579699522323').children('.module');
    });
  
        jQuery(function() {
            var $module = jQuery('#m-1579691753008').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1579707058501').children('.module');

            var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
            if(mode == 'production') { 
                $module.find('button[type="submit"]').on('mouseover', function() {
                    try {
                        localStorage.setItem('gemId', '#m-1579707058501');
                    } catch(err) {}
                });
    ...
    jQuery(function() {
        ...
        jQuery(function() {
          ...
          jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1604589088463').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1604589088463').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1604589088463');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1604589088463').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1604589088463').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1604589088463').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
