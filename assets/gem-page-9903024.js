...
jQuery(function() {
  try {
    var $module = jQuery('#m-1585409689297').children('.module');
    ...
    $module.children('[data-accordion]').children('[data-content]').children().css('border-bottom', borderSize + ' solid ' + borderColor);
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1585155981652');
            var $module = jQuery('#m-1585155981652').children('.module');
    ...
    jQuery(function() {
  var $hero = jQuery('#m-1585155820299');
  var $module = jQuery('#m-1585155820299').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1585583752741').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1585583752710').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1585583752676').children('.module');
        }); 
