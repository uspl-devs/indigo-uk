        ...
        jQuery(function() {
            var $hero = jQuery('#m-1572797339071');
            var $module = jQuery('#m-1572797339071').children('.module');
    ...
    jQuery(function() {
  var $hero = jQuery('#m-1579537218416');
  var $module = jQuery('#m-1579537218416').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
          ...
          jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1603209410624').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1603209410624').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1603209410624');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1603209410624').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1603209410624').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1603209410624').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
      
        jQuery(function() {
            var $module = jQuery('#m-1603209410641').children('.module');
        ...
        jQuery(function() {
            var $module = jQuery('#m-1574962630200').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1574962630096').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1574962630244').children('.module');
        }); 
    
        jQuery(function() {
            var $module = jQuery('#m-1574962630129').children('.module');
