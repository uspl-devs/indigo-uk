        ...
        jQuery(function() {
            var $hero = jQuery('#m-1578156654711');
            var $module = jQuery('#m-1578156654711').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1578331530092');
            var $module = jQuery('#m-1578331530092').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1602606416666');
            var $module = jQuery('#m-1602606416666').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1602606416760');
            var $module = jQuery('#m-1602606416760').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1599227261460');
            var $module = jQuery('#m-1599227261460').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1599227261329');
            var $module = jQuery('#m-1599227261329').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1602606019359');
            var $module = jQuery('#m-1602606019359').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1602606019444');
            var $module = jQuery('#m-1602606019444').children('.module');
        ...
        jQuery(function() {
            var $hero = jQuery('#m-1576584868657');
            var $module = jQuery('#m-1576584868657').children('.module');
    ...
    jQuery(function() {
  var $hero = jQuery('#m-1579538057275');
  var $module = jQuery('#m-1579538057275').children('.module');
  ...
  if($module.attr('data-fixedMode') == '1'){
    ...
    $module.parent().removeAttr('style');
        ...
        jQuery(function() {
          ...
          jQuery(function() {
  var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
  var $module = jQuery('#m-1602603696604').children('.module');
  if (mode == 'dev') {
      jQuery('#m-1602603696604').attr('data-name', '').css('background-image', 'none').removeAttr('data-image');
      
      var flag = true;
      var $bkLiquid = parent.jQuery('body').find('#gfFrame').contents().find('#module-1602603696604');
      if ($bkLiquid && $bkLiquid.length > 0) {
          ...
          try {
              ...
              if (imageUrl != '') {
                  flag = false;
                  jQuery('#m-1602603696604').css('background-image', 'url(' + imageUrl + ')').css('min-height', '100px').attr('data-image', 'true');
              }
              if (name != '' && name != 'Custom Code') {
                  flag = false;
                  jQuery('#m-1602603696604').attr('data-name', name);
              }
          } catch(error) {
              console.log(error);
          }
      ...
      if (flag) {
          jQuery('#m-1602603696604').attr('data-name', 'Right click on the module, then choose Edit Html / Liquid option to start writing your custom code.');
      }
  }
});
      
        jQuery(function() {
            var $module = jQuery('#m-1602603696621').children('.module');
