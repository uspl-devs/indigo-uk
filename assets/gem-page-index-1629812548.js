...
(function( jQuery ){
  // var $module = jQuery('#m-1627301433103').children('.module');
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1617856208806').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
...
(function( jQuery ){
  try {
    var $module = jQuery('#m-1617856779847').children('.module');   
    var navspeed = $module.data('navspeed'),
      autoplaytimeout = $module.data('autoplaytimeout'),
      autoplayhoverpause = $module.data('autoplayhoverpause'),
      navlg = $module.data('navlg'),
  ...
  if(mode == 'production') { 
    ...
    if(gemId != '') {
      ...
      if(cbLink && cbLink != '') {
        ...
        jQuery(function() {
            var $module = jQuery('#m-1627311170696').children('.module');
            $module.gfV1Gmap();
