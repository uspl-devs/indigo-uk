        ...
        jQuery(function() {
            var $module = jQuery('#m-1710247746554').children('.module');
            $module.gfV3ProductPrice();
        }); 
    jQuery(function() {
        var $module = jQuery('#m-1710247746558').children('.module');
...
jQuery(".txt_word").text(variant.sku);
 if(variant.available == false){
  ...
  jQuery(function() {
            var $module = jQuery('#m-1710247370359').children('.module');
    ...
    (function( jQuery ){
  // var $module = jQuery('#m-1710249161157').children('.module');
  ...
  try {
    ...
    (function( jQuery ){
  var $module = jQuery('#m-1710190511771').children('.module');
  ...
  if($('.gempage-editing').length < 1) {
    var $module = jQuery('#m-1667326507172').children('.module');
    var product = $module.closest('[data-label="Product"]')
